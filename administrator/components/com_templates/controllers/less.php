 ...
 * @since       1.6
 */
class TemplatesControllerLess extends JControllerLegacy
{
	/**
	 * Constructor.
	 *
	 ...
	 */
	public function getModel($name = 'Less', $prefix = 'TemplatesModel', $config = array())
	{
	...
	public function cancel()
	{
		...
		$context	= 'com_templates.default.less';
	...
	public function save()
	{
		...
		if (!$model->save($data))
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_templates&view=less', false));
